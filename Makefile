...
#    Updated: 2020/10/12 01:58:52 by swquinc          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
o_sphere.c o_plane.c o_square.c o_cylinder.c o_triangle.c raytrace.c

OBJ				=	main.o errors_handler.o parse_main.o parse_utils.o parse_utils2.o parse_obj.o camera.o vec.o vec2.o \
o_sphere.o o_plane.o o_square.o o_cylinder.o o_triangle.o raytrace.o
